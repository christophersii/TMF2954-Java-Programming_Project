...
public class Main extends javax.swing.JFrame implements LoadingInterface{
    public Main() {
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("MEAL DIARY");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/potato (3).png"))); // NOI18N
